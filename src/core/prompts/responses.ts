...
export const formatResponse = {
	...
	haiIgnoreError: (path: string) =>
		`Access to ${path} is blocked by the .hai.ignore file settings. You must try to continue in the task without using this file, or ask the user to update the .hai.ignore file.`,
