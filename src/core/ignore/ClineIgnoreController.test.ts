...
describe("ClineIgnoreController", () => {
	...
	describe("Include Directive", () => {
		it("should load patterns from an included file", async () => {
			...
			// Create a .haiignore file that includes .gitignore and adds an extra pattern "secret.txt"
			...
			// "secret.txt" should be ignored as specified directly in .haiignore
		...
		it("should handle non-existent included file gracefully", async () => {
			// Create a .haiignore file that includes a non-existent file
