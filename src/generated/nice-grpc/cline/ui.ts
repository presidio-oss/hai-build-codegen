...
import { Boolean, BooleanRequest, Empty, EmptyRequest, KeyValuePair, Metadata, String, StringRequest } from "./common";
...
export const HaiTask: MessageFns<HaiTask> = {
  ...
  create(base?: DeepPartial<HaiTask>): HaiTask {
    return HaiTask.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HaiTask>): HaiTask {
    const message = createBaseHaiTask();
...
export const HaiStory: MessageFns<HaiStory> = {
  ...
  create(base?: DeepPartial<HaiStory>): HaiStory {
    return HaiStory.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HaiStory>): HaiStory {
    const message = createBaseHaiStory();
    message.id = object.id ?? "";
...
export const HaiTasksLoadRequest: MessageFns<HaiTasksLoadRequest> = {
  ...
  create(base?: DeepPartial<HaiTasksLoadRequest>): HaiTasksLoadRequest {
    return HaiTasksLoadRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HaiTasksLoadRequest>): HaiTasksLoadRequest {
    const message = createBaseHaiTasksLoadRequest();
...
export const HaiTaskDataResponse: MessageFns<HaiTaskDataResponse> = {
  ...
  create(base?: DeepPartial<HaiTaskDataResponse>): HaiTaskDataResponse {
    return HaiTaskDataResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HaiTaskDataResponse>): HaiTaskDataResponse {
    const message = createBaseHaiTaskDataResponse();
...
export const UpdateTaskStatusRequest: MessageFns<UpdateTaskStatusRequest> = {
  ...
  create(base?: DeepPartial<UpdateTaskStatusRequest>): UpdateTaskStatusRequest {
    return UpdateTaskStatusRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateTaskStatusRequest>): UpdateTaskStatusRequest {
    const message = createBaseUpdateTaskStatusRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata.fromPartial(object.metadata)
      : undefined;
...
export const UpdateTaskStatusResponse: MessageFns<UpdateTaskStatusResponse> = {
  ...
  create(base?: DeepPartial<UpdateTaskStatusResponse>): UpdateTaskStatusResponse {
    return UpdateTaskStatusResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateTaskStatusResponse>): UpdateTaskStatusResponse {
    const message = createBaseUpdateTaskStatusResponse();
...
export interface UiServiceImplementation<CallContextExt = {}> {
  ...
  /** Load HAI tasks from a folder path or show folder picker if path is not provided */
  loadHaiTasks(request: HaiTasksLoadRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Reset HAI tasks and clear configuration */
  resetHaiTasks(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Subscribe to HAI task data updates (streams task data when available) */
  subscribeToHaiTaskData(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): ServerStreamingMethodResult<DeepPartial<HaiTaskDataResponse>>;
  /** Update the status of a HAI task */
  updateTaskStatus(
    request: UpdateTaskStatusRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<UpdateTaskStatusResponse>>;
}
...
export interface UiServiceClient<CallOptionsExt = {}> {
  ...
  /** Load HAI tasks from a folder path or show folder picker if path is not provided */
  loadHaiTasks(request: DeepPartial<HaiTasksLoadRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Reset HAI tasks and clear configuration */
  resetHaiTasks(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Subscribe to HAI task data updates (streams task data when available) */
  subscribeToHaiTaskData(
    request: DeepPartial<EmptyRequest>,
    options?: CallOptions & CallOptionsExt,
  ): AsyncIterable<HaiTaskDataResponse>;
  /** Update the status of a HAI task */
  updateTaskStatus(
    request: DeepPartial<UpdateTaskStatusRequest>,
    options?: CallOptions & CallOptionsExt,
