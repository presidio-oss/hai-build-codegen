...
/** HAI Story definition */
export interface HaiStory {
  id: string;
  prdId: string;
  name: string;
  description: string;
...
/** Request to load HAI tasks */
export interface HaiTasksLoadRequest {
  metadata:
    | Metadata1
    | undefined;
  /** Optional: if not provided, will show folder picker */
  folderPath: string;
  /** Whether to load from previously configured folder */
  loadDefault: boolean;
}

/** Response containing HAI task data */
export interface HaiTaskDataResponse {
  stories: HaiStory[];
  folderPath: string;
  timestamp: string;
}
...
/** Response for task status update */
...
function createBaseHaiTask(): HaiTask {
  return { id: "", list: "", acceptance: "", subTaskTicketId: "", status: "" };
}

export const HaiTask: MessageFns<HaiTask> = {
  encode(message: HaiTask, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
    ...
    if (message.acceptance !== "") {
      writer.uint32(26).string(message.acceptance);
    }
    if (message.subTaskTicketId !== "") {
      writer.uint32(34).string(message.subTaskTicketId);
    }
    if (message.status !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HaiTask {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseHaiTask();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.acceptance = reader.string();
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.subTaskTicketId = reader.string();
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): HaiTask {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      list: isSet(object.list) ? globalThis.String(object.list) : "",
      acceptance: isSet(object.acceptance) ? globalThis.String(object.acceptance) : "",
      subTaskTicketId: isSet(object.subTaskTicketId)
        ? globalThis.String(object.subTaskTicketId)
        : isSet(object.sub_task_ticket_id)
        ? globalThis.String(object.sub_task_ticket_id)
        : "",
      status: isSet(object.status) ? globalThis.String(object.status) : "",
    };
  },

  toJSON(message: HaiTask): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
    ...
    if (message.acceptance !== "") {
      obj.acceptance = message.acceptance;
    }
    if (message.subTaskTicketId !== "") {
      obj.subTaskTicketId = message.subTaskTicketId;
    }
    if (message.status !== "") {
  ...
  create<I extends Exact<DeepPartial<HaiTask>, I>>(base?: I): HaiTask {
    return HaiTask.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<HaiTask>, I>>(object: I): HaiTask {
    const message = createBaseHaiTask();
    message.id = object.id ?? "";
    message.list = object.list ?? "";
    message.acceptance = object.acceptance ?? "";
    message.subTaskTicketId = object.subTaskTicketId ?? "";
    message.status = object.status ?? "";
    return message;
  },
};

function createBaseHaiStory(): HaiStory {
  return { id: "", prdId: "", name: "", description: "", storyTicketId: "", tasks: [] };
}

export const HaiStory: MessageFns<HaiStory> = {
  encode(message: HaiStory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.prdId !== "") {
      writer.uint32(18).string(message.prdId);
    }
    if (message.name !== "") {
    ...
    if (message.storyTicketId !== "") {
      writer.uint32(42).string(message.storyTicketId);
    }
    for (const v of message.tasks) {
      HaiTask.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): HaiStory {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseHaiStory();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 5: {
          ...
          message.storyTicketId = reader.string();
          continue;
        }
        case 6: {
          if (tag !== 50) {
          ...
          message.tasks.push(HaiTask.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HaiStory {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      prdId: isSet(object.prdId)
        ? globalThis.String(object.prdId)
        : isSet(object.prd_id)
        ? globalThis.String(object.prd_id)
        : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      description: isSet(object.description) ? globalThis.String(object.description) : "",
      storyTicketId: isSet(object.storyTicketId)
        ? globalThis.String(object.storyTicketId)
        : isSet(object.story_ticket_id)
        ? globalThis.String(object.story_ticket_id)
        : "",
      tasks: globalThis.Array.isArray(object?.tasks) ? object.tasks.map((e: any) => HaiTask.fromJSON(e)) : [],
    };
  },

  toJSON(message: HaiStory): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
    if (message.prdId !== "") {
      obj.prdId = message.prdId;
    }
    if (message.name !== "") {
    ...
    if (message.storyTicketId !== "") {
      obj.storyTicketId = message.storyTicketId;
    }
    if (message.tasks?.length) {
      obj.tasks = message.tasks.map((e) => HaiTask.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<HaiStory>, I>>(base?: I): HaiStory {
    return HaiStory.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<HaiStory>, I>>(object: I): HaiStory {
    const message = createBaseHaiStory();
    message.id = object.id ?? "";
    message.prdId = object.prdId ?? "";
    message.name = object.name ?? "";
    message.description = object.description ?? "";
    message.storyTicketId = object.storyTicketId ?? "";
    message.tasks = object.tasks?.map((e) => HaiTask.fromPartial(e)) || [];
    return message;
  },
};

function createBaseHaiTasksLoadRequest(): HaiTasksLoadRequest {
  return { metadata: undefined, folderPath: "", loadDefault: false };
}

export const HaiTasksLoadRequest: MessageFns<HaiTasksLoadRequest> = {
  encode(message: HaiTasksLoadRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.loadDefault !== false) {
      writer.uint32(24).bool(message.loadDefault);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): HaiTasksLoadRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseHaiTasksLoadRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.loadDefault = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HaiTasksLoadRequest {
    return {
      ...
      folderPath: isSet(object.folderPath)
        ...
        : "",
      loadDefault: isSet(object.loadDefault)
        ? globalThis.Boolean(object.loadDefault)
        : isSet(object.load_default)
        ? globalThis.Boolean(object.load_default)
        : false,
    };
  },

  toJSON(message: HaiTasksLoadRequest): unknown {
    const obj: any = {};
    if (message.metadata !== undefined) {
    ...
    if (message.loadDefault !== false) {
      obj.loadDefault = message.loadDefault;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<HaiTasksLoadRequest>, I>>(base?: I): HaiTasksLoadRequest {
    return HaiTasksLoadRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<HaiTasksLoadRequest>, I>>(object: I): HaiTasksLoadRequest {
    const message = createBaseHaiTasksLoadRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata1.fromPartial(object.metadata)
      : undefined;
    message.folderPath = object.folderPath ?? "";
    message.loadDefault = object.loadDefault ?? false;
    return message;
  },
};

function createBaseHaiTaskDataResponse(): HaiTaskDataResponse {
  return { stories: [], folderPath: "", timestamp: "" };
}

export const HaiTaskDataResponse: MessageFns<HaiTaskDataResponse> = {
  encode(message: HaiTaskDataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.stories) {
      HaiStory.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.folderPath !== "") {
      writer.uint32(18).string(message.folderPath);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HaiTaskDataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseHaiTaskDataResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.stories.push(HaiStory.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): HaiTaskDataResponse {
    return {
      stories: globalThis.Array.isArray(object?.stories) ? object.stories.map((e: any) => HaiStory.fromJSON(e)) : [],
      folderPath: isSet(object.folderPath)
        ? globalThis.String(object.folderPath)
        : isSet(object.folder_path)
        ? globalThis.String(object.folder_path)
  ...
  toJSON(message: HaiTaskDataResponse): unknown {
    const obj: any = {};
    if (message.stories?.length) {
      obj.stories = message.stories.map((e) => HaiStory.toJSON(e));
    }
    if (message.folderPath !== "") {
      obj.folderPath = message.folderPath;
    }
  ...
  create<I extends Exact<DeepPartial<HaiTaskDataResponse>, I>>(base?: I): HaiTaskDataResponse {
    return HaiTaskDataResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<HaiTaskDataResponse>, I>>(object: I): HaiTaskDataResponse {
    const message = createBaseHaiTaskDataResponse();
    message.stories = object.stories?.map((e) => HaiStory.fromPartial(e)) || [];
    message.folderPath = object.folderPath ?? "";
...
function createBaseUpdateTaskStatusRequest(): UpdateTaskStatusRequest {
  return { metadata: undefined, folderPath: "", taskId: "", status: "" };
}
...
export const UiServiceDefinition = {
  ...
  methods: {
    ...
    /** Subscribe to HAI Build Task List button click events */
    subscribeToHaiBuildTaskListClicked: {
      name: "subscribeToHaiBuildTaskListClicked",
      requestType: EmptyRequest,
      requestStream: false,
      responseType: Empty,
      responseStream: true,
    ...
    loadHaiTasks: {
      name: "loadHaiTasks",
      requestType: HaiTasksLoadRequest,
      requestStream: false,
      responseType: Empty,
      responseStream: false,
      options: {},
    ...
    /** Subscribe to HAI task data updates (streams task data when available) */
    subscribeToHaiTaskData: {
      name: "subscribeToHaiTaskData",
      requestType: EmptyRequest,
      requestStream: false,
      responseType: HaiTaskDataResponse,
      responseStream: true,
      options: {},
    },
    /** Update the status of a HAI task */
    updateTaskStatus: {
      name: "updateTaskStatus",
      requestType: UpdateTaskStatusRequest,
      requestStream: false,
...
export const UiServiceService = {
  ...
  /** Subscribe to HAI Build Task List button click events */
  subscribeToHaiBuildTaskListClicked: {
    path: "/cline.UiService/subscribeToHaiBuildTaskListClicked",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Load HAI tasks from a folder path or show folder picker if path is not provided */
  loadHaiTasks: {
    path: "/cline.UiService/loadHaiTasks",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: HaiTasksLoadRequest): Buffer => Buffer.from(HaiTasksLoadRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): HaiTasksLoadRequest => HaiTasksLoadRequest.decode(value),
    responseSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer): Empty => Empty.decode(value),
  },
  /** Reset HAI tasks and clear configuration */
  resetHaiTasks: {
    path: "/cline.UiService/resetHaiTasks",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Subscribe to HAI task data updates (streams task data when available) */
  subscribeToHaiTaskData: {
    path: "/cline.UiService/subscribeToHaiTaskData",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: HaiTaskDataResponse): Buffer => Buffer.from(HaiTaskDataResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): HaiTaskDataResponse => HaiTaskDataResponse.decode(value),
  },
  /** Update the status of a HAI task */
  updateTaskStatus: {
    path: "/cline.UiService/updateTaskStatus",
    requestStream: false,
    responseStream: false,
...
export interface UiServiceServer extends UntypedServiceImplementation {
  ...
  /** Subscribe to HAI Build Task List button click events */
  subscribeToHaiBuildTaskListClicked: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to settings button clicked events */
  ...
  /** Load HAI tasks from a folder path or show folder picker if path is not provided */
  loadHaiTasks: handleUnaryCall<HaiTasksLoadRequest, Empty>;
  /** Reset HAI tasks and clear configuration */
  resetHaiTasks: handleUnaryCall<EmptyRequest, Empty>;
  /** Subscribe to HAI task data updates (streams task data when available) */
  subscribeToHaiTaskData: handleServerStreamingCall<EmptyRequest, HaiTaskDataResponse>;
  /** Update the status of a HAI task */
...
export interface UiServiceClient extends Client {
  ...
  subscribeToHaiTaskData(
    request: EmptyRequest,
    options?: Partial<CallOptions>,
  ): ClientReadableStream<HaiTaskDataResponse>;
  subscribeToHaiTaskData(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
