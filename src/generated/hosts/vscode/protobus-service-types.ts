...
export type UiServiceHandlers = {
     ...
     subscribeToHaiBuildTaskListClicked:(controller: Controller, request: proto.cline.EmptyRequest, responseStream: StreamingResponseHandler<proto.cline.Empty>, requestId?: string) => Promise<void>
     ...
     loadHaiTasks:(controller: Controller, request: proto.cline.HaiTasksLoadRequest) => Promise<proto.cline.Empty>
     resetHaiTasks:(controller: Controller, request: proto.cline.EmptyRequest) => Promise<proto.cline.Empty>
     subscribeToHaiTaskData:(controller: Controller, request: proto.cline.EmptyRequest, responseStream: StreamingResponseHandler<proto.cline.HaiTaskDataResponse>, requestId?: string) => Promise<void>
     updateTaskStatus:(controller: Controller, request: proto.cline.UpdateTaskStatusRequest) => Promise<proto.cline.UpdateTaskStatusResponse>
}
