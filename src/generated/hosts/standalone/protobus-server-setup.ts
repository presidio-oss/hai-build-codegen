...
import { subscribeToHaiBuildTaskListClicked } from "@core/controller/ui/subscribeToHaiBuildTaskListClicked"
...
import { loadHaiTasks } from "@core/controller/ui/loadHaiTasks"
import { resetHaiTasks } from "@core/controller/ui/resetHaiTasks"
import { subscribeToHaiTaskData } from "@core/controller/ui/subscribeToHaiTaskData"
import { updateTaskStatus } from "@core/controller/ui/updateTaskStatus"
...
export function addProtobusServices(
    ...
    server.addService(cline.UiServiceService, {
        ...
        subscribeToHaiBuildTaskListClicked: wrapStreamingResponse<cline.EmptyRequest,cline.Empty>(subscribeToHaiBuildTaskListClicked, controller),
        ...
        subscribeToShowWebview: wrapStreamingResponse<cline.EmptyRequest,cline.ShowWebviewEvent>(subscribeToShowWebview, controller),
         ...
         loadHaiTasks: wrapper<cline.HaiTasksLoadRequest,cline.Empty>(loadHaiTasks, controller),
         resetHaiTasks: wrapper<cline.EmptyRequest,cline.Empty>(resetHaiTasks, controller),
        subscribeToHaiTaskData: wrapStreamingResponse<cline.EmptyRequest,cline.HaiTaskDataResponse>(subscribeToHaiTaskData, controller),
         updateTaskStatus: wrapper<cline.UpdateTaskStatusRequest,cline.UpdateTaskStatusResponse>(updateTaskStatus, controller),
    });
